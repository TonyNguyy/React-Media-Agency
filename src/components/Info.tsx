        ...
        lg:flex-row gap-8 xl:gap-[180px]">
            ...
            xl:gap-y-[70px]">
                <div className="">
                    ...
                    <p className="mb-3 font-b old text-gray-600">Satisfied Clients</p>
                    <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum amet suscipit, id unde voluptate aliquam. Tempore repellendus sint ad reiciendis?</p>
                </div>
                <div>
